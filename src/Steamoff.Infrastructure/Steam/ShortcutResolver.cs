...
/// <summary>Resolves the target executable path of a .lnk shortcut via the Shell COM IShellLink interface (no extra NuGet dependency).</summary>
internal static class ShortcutResolver
{
    public static string? TryResolveTarget(string lnkPath)
    {
        try
        {
