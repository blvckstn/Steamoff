...
Steamoff — маленькая Windows-утилита, которая включает и выключает интернет для Стима (Steam) и других приложений.
...
>
> "Бред, Steam Offline Mode пишет, что сначала надо зайти онлайн."
>
> "Мне нужен браузер и Discord онлайн, но Steam должен быть оффлайн."
>
> "Как запретить интернет одной игре, не отключая весь компьютер?"
>
> "Я тестирую билд и хочу понять, как он ведёт себя без сети."

Кейсы в которых пригодится Steamoff.

Хоть встроенный автономный режим Steam частично полезен, но он остаётся режимом внутри клиента. Он может зависеть от авторизации, кэша, состояния обновлений и того, что Steam решил проверить перед запуском.

Steamoff работает глубже — на уровне Microsoft Defender Firewall. Если автономный режим включён, Steam и выбранные приложения просто не получают сетевой доступ. Для задачи "не пускать программу в интернет" это надёжнее, чем просить Steam вести себя офлайн.
